...
import { GetProfileLoad, GetProfileSuccess, GetProfileFail}  from './profile.actions';
...
const _profilereducer = createReducer (
  initialState,
  on (GetProfileLoad, state => ( { ...state , isLoading:true})),
  on (GetProfileSuccess, ( state, {data} ) => (
    { ...state , isLoading:false, message: 'Perfil cargado correctamente!', data: data})
    ),
...
/*
        case ProfileActionTypes.GetProfileSuccess: {
            return {
                ...state,
                profile: (<GetProfileSuccess>action).profile,
                isLoading: false,
        ...
        /*case ProfileActionTypes.PostProfile: {
            return {
                ...state,
                isLoading: true
            }
        ...
        case ProfileActionTypes.PostProfileSuccess: {
        ...
        case ProfileActionTypes.PostProfileFail: {
            return {
                profile: initialUser,
                isLoading: false,
                message: 'Algo fue mal!'
